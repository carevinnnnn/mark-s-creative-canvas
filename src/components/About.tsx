      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-3 gap-12 lg:gap-20">
          ...
          <div className="space-y-8" ref={(el) => { 
            ...
            {/* Minimalist Laptop Drawing with Animations + Parallax */}
            <div className={`hidden lg:block group transition-all duration-700 ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              >
                {/* Laptop Screen - floating + parallax layer 2 */}
                <g className={isInView ? "animate-float" : ""} style={getLayerStyle(2)}>
                ...
                {/* Animated Cursor - clicking + parallax layer 1 */}
                <g className={isInView ? "animate-cursor-click" : ""} style={{ ...getLayerStyle(1), transformOrigin: '145px 55px' }}>
